...
def main(): 
    # Training settings E:\A-学习盘文件\CCNU\UTS代码\GraphRec\CAMRa2011_crisp\sparser_datagenerate\groupMember
    parser = argparse.ArgumentParser(description='Social Recommendation: GraphRec model')
    parser.add_argument('--path', type=str, default='E:/A-学习盘文件/CCNU/UTS代码/GraphRec/CAMRa2011_crisp/sparser_datagenerate/t1result_1000')
    parser.add_argument('--user_dataset', type=str, default= 'E:/A-学习盘文件/CCNU/UTS代码/GraphRec/CAMRa2011_crisp/sparser_datagenerate/' + 'userRating')
    parser.add_argument('--group_dataset', type=str, default= 'E:/A-学习盘文件/CCNU/UTS代码/GraphRec/CAMRa2011_crisp/sparser_datagenerate/' + 't1_groupRating')
    parser.add_argument('--user_in_group_path', type=str, default= 'E:/A-学习盘文件/CCNU/UTS代码/GraphRec/CAMRa2011_crisp/sparser_datagenerate/groupMember')
    
    parser.add_argument('--batch_size_list', type=list, default=[128], metavar='N', help='input batch size for training')
    parser.add_argument('--embed_dim_list', type=list, default=[60], metavar='N', help='embedding size')
    parser.add_argument('--lr_list', type=list, default=[0.001], metavar='LR', help='learning rate')
        ...
        for embed_dim in args.embed_dim_list:
            for lr in args.lr_list:
                for i in range(1):
                    ...
                    # filename = "EVA_UserRMSE_MAE_bat%d_emb%d_lr%1.5f_i"%(batch_size, embed_dim, lr, i)
                    ...
                    np.savetxt(filename, EVA_gro, fmt='%1.4f', delimiter=' ')
